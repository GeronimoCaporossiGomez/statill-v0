...
export const routes: Routes = [
  ...
  },
  {
    path: 'catalogo',
    loadComponent: () =>
      import('../app/comercio/catalogo/catalogo.component').then(
  ...
  },
  {
    path: 'negocio/:id',
    loadComponent: () =>
      import('../app/negocio/negocio.component').then(
  ...
  },
  {
    path: 'preordenes',
    loadComponent: () =>
      import('../app/preordenes/preordenes.component').then(
  ...
  },
  {
    path: 'crear-comercio',
    loadComponent: () =>
      import('../app/comercio/crear-comercio/crear-comercio.component').then(
  ...
  // Requires store owner role
  {
    path: 'stock',
    loadComponent: () =>
      import('../app/comercio/stock/stock.component').then(
        (m) => m.StockComponent,
      ),
  ...
  },
  {
    path: 'escanear',
    loadComponent: () =>
      import('../app/comercio/escanear/escanear.component').then(
  ...
  },
  {
    path: 'estadisticas',
    loadComponent: () =>
      import('../app/comercio/estadisticas/estadisticas.component').then(
  ...
  },
  {
    path: 'configuracion',
    loadComponent: () =>
      import('../app/configuracion/configuracion.component').then(

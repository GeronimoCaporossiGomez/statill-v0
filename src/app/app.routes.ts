...
export const routes: Routes = [
  ...
  },
  {
    path: 'catalogo',
    loadComponent: () =>
      import('./comercio/catalogo/catalogo.component').then(m => m.CatalogoComponent)
  },
  {
    path: 'mapa',
    loadComponent: () =>
  ...
  },
  {
    path: 'preordenes',
    loadComponent: () =>
      import('./preordenes/preordenes.component').then(m => m.PreordenesComponent),
    canActivate: [authGuard]
  },
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/Confirmation/Confirmation.component').then(m => m.OrdenConfirmacionComponent),
    canActivate: [activeUserGuard]
  },
  {
    path: 'metodo-pago-no-disponible',
    loadComponent: () =>
      import('./pages/metodo-pago-no-disponible/metodo-pago-no-disponible.component').then(m => m.MetodoPagoNoDisponibleComponent),
    canActivate: [activeUserGuard]
  },
